(() => {
    ...
    const billAndTed = ["T am Bill S Present, Esq", "And I am Ted Theodore Logan!"];

    function showBioResult() {
    ...
    bioButtons.forEach(button => button.addEventListener("click", showBioResult));
